...
req(back['status']=='owner_approved_active_parallel_work' and next(x for x in back['work_items'] if x['id']=='CAPP-01')['status']=='in_progress','CAPP backlog start state')
req(cp['status']=='started','CAPP-01 checkpoint start state')
