...
- CSV row-width consistency: **all 20 files match their declared header width**
...
| `profession_and_crafting_ability_trees_catalog.csv` | 221 | 58 | none detected |
| `prestige_environment_and_special_ability_trees_catalog.csv` | 1,018 | 58 | none detected |
| `species_elementalist_and_innate_abilities_catalog.csv` | 2,203 | 58 | none detected |
| `ability_trees_and_abilities_catalog.csv` | 1,256 | 58 | none detected |
...
| `expanded_hazards_and_traps_all_genres.csv` | 1,901 | 87 | none detected |
| `expanded_mecha_and_components_all_genres.csv` | 2,117 | 88 | none detected |
...
The audit detected no ragged rows and no exact duplicate full rows. Repeated names and source names remain expected collision signals and must be resolved by the cross-file identity index rather than automatically merged.
...
5. Do not silently merge duplicate names, fill missing values, normalize contradictory mechanics, or promote records.
