...
- application PR #268
- validated head `65efdbfbd1c29185a6d324390cb32f04aba56fda`
- repository-health run `32506120186`
- product/self-hosted validation run `32506120483`
- Windows job `96846553417`; artifact `9455377223`
- Linux job `96846552991`; artifact `9455380382`
- deterministic comparison job `96847289299`; artifact `9455385598`
...
Completed: MSS-01 source inventory/authority crosswalk/taxonomy; MSS-02 resources/capacity/cost/strain/Overreach; MSS-03 unified spell/power/supernatural resolution; MSS-04 Rune Construction runtime/blind GM adjudication.
