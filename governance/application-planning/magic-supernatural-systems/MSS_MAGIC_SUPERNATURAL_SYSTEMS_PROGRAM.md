...
MSS converts the substantial retained magic/supernatural source corpus and completed PPIA-07 Rune Construction design into one governed application-runtime family. It covers ordinary spell/power resolution, Rune Construction, casting resources and strain, traditions, rituals, counterplay, spirits/divine relationships, portals and temporal/causal play without creating a second Action/Event, Character, Item, World/Reality, crafting or approval authority.
...
7. **MSS-07 — Rituals, Circles, Components & Cooperative Casting**  
   Implement long-form ritual Projects, circles/wards, multiple participants, staged requirements, places/times/components, interruption, accumulated progress, cooperative contribution and consequences through APW/MIB-12/ICF seams.

8. **MSS-08 — Countermagic, Resistance, Wards, Suppression & Backlash**  
   Complete resistance/saves/counterspell/dispelling/anti-magic/warding/interruption/suppression/failure/backlash interactions with deterministic precedence and no bypass of owning combat/condition rules.

9. **MSS-09 — Spirits, Patronage, Worship, Pacts & Divine Favor**  
   Govern spirit interaction, patrons/deities, offerings, vows, taboos, favor/debt, pacts, spiritual obligations, intervention requests and religion-linked supernatural effects while keeping relationship, organization, Character and GM authority separate.

10. **MSS-10 — Portals, Gates & Multiversal Transit**  
    Implement portal/gate discovery, activation requirements, keys, destinations, one-way/restricted links, instability, misrouting, networks and cross-Reality compatibility using MIB-11 World/Reality identity and MAI later as presentation rather than transit truth.

11. **MSS-11 — Temporal/Causal Play, Branching & Paradox Governance**  
    Implement travel or effects across Timeline/Era boundaries, branch creation, causal edits, protected/fixed events where authored, alternate futures, knowledge provenance, paradox/conflict classification and safe return/reconciliation without rewriting historical truth silently.

12. **MSS-12 — Supernatural Content Packs, Workbench, Balance & Golden Proof**  
    Publish searchable spell/power/rune/tradition/ritual/counterplay/portal/temporal packs; route the retained spell corpus; expose inspectors and creator tools; and prove a cross-tradition golden scenario with no-AI operation, GM adjudication, recovery, provenance and setting-local rules.
