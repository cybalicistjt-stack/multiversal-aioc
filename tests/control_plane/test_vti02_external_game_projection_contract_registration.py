...
class Vti02ExternalGameProjectionContractRegistrationTests(unittest.TestCase):
    def test_vti02_completed_lifecycle_and_current_successor_are_consistent(self):
        ...
        self.assertGreater(order.index(current), order.index("VTI-02"))
        ...
        for phrase in ("VTI-02 — Multiversal External Game Projection Contract","COMPLETED_VERIFIED","VTI-03 — Stable Identity, Versioning & Synchronization","VTI-04 — Rules Action & Roll Bridge","VTI-05 — Character Sheet, Item & Compendium Projection","Platform selection remains evidence-driven"):
