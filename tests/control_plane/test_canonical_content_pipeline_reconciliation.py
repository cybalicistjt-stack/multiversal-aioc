...
def main() -> None:
    ...
    assert certificate["replacementRecordCount"] == 135
    assert certificate["supplementalInputRecordCount"] == 204
    ...
    print(
        ...
        f"{index['recordCount']} effective records; 69 appends + 135 governed replacements; Beacon Debt mechanics and exact references resolve."
    )
