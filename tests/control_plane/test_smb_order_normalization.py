...
class SmbOrderingTests(unittest.TestCase):
 ...
 def test_saa_sits_between_core_and_final_creator_integration(self):self.assertIn("SMB10A",self.e["SAA"]["start_requires"]);self.assertIn("SAA-30",self.e["SMB10B"]["start_requires"])
