...
def test_mlr_is_registered_without_replacing_product_authority():
    ...
    assert (
        "machine_local_work_order",
        "governance/ai/runtime/LOCAL_WORKSTATION_RESOURCE_ACQUISITION_WORK_ORDER.md",
        "CURRENT_COMPATIBLE",
    ) in paths
    assert (
        "machine_local_resource_manifest",
        "governance/ai/runtime/LOCAL_WORKSTATION_RESOURCE_MANIFEST.json",
        "CURRENT_COMPATIBLE",
    ) in paths
