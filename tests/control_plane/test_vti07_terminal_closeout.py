...
class Vti07TerminalCloseoutTests(unittest.TestCase):
    def test_vti07_terminal_evidence_and_vti08_selection(self):
        ...
        self.assertEqual(nxt["status"],"selected_not_started"); self.assertEqual(nxt["application_baseline_sha"],"692da4f4792426b9c62f6be14db60fc63eb09d6b")
