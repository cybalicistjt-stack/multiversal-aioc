...
class Alp06RehearsalRetrySafeFailureTrainingProjectRegistrationTests(unittest.TestCase):
    def test_alp06_governed_start_or_closeout_is_consistent(self):
        ...
        if checkpoint["status"] == "in_progress":
            ...
            self.assertTrue(registry["alp_07_authority"]["selected_not_started"])
            self.assertFalse(registry["alp_07_authority"]["implementation_authority"])
            self.assertIsNone(registry["alp_07_authority"]["implementation_branch"])
