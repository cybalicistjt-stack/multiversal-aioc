...
def test_mcs_registered_as_future_interstitial_without_activation():
    ...
    assert planned["MCS"]["successor"] == "SMB-08"
...
def test_mcs_dependency_placement_and_successors():
    ...
    smb = t("governance/application-planning/system-maturation-buildout/SMB_MCS_INTERSTITIAL_INTEGRATION_AMENDMENT_2026-09-11.md")
    for doc in (amendment, smb):
        assert "PCA-01..16 → MCS-01..21 → SMB-08" in doc
