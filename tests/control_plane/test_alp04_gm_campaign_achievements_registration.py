...
class Alp04GmCampaignAchievementsRegistrationTests(unittest.TestCase):
    def test_alp04_remains_completed_while_successors_may_advance(self):
        ...
        self.assertIn(backlog["completed_through"], {"ALP-04", "ALP-05", "ALP-06", "ALP-07", "ALP-08"})
        self.assertIn(backlog["current_item"], {"ALP-05", "ALP-06", "ALP-07", "ALP-08", None})
        ...
        elif backlog["completed_through"] == "ALP-07":
        ...
        elif backlog["completed_through"] == "ALP-08":
